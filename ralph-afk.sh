...
for ((i=1; i<=$1; i++)); do
  opencode --model anthropic/claude-4.5-opus --log-level DEBUG --prompt "@docs/prd.json @docs/ARCHITECTURE.md @docs/USERFLOW.md @docs/PRODUCT.md @docs/FLINT.md @docs/progress.txt \
