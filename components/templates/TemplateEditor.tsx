    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a reusable template for your notes. Use template variables to auto-fill dynamic content.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={noteType} onValueChange={(value) => setNoteType(value as 'note' | 'journal')}>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Show this template first when creating new {noteType === 'journal' ? 'journal entries' : 'notes'}
              </p>
            </div>
            <Switch
              id="isDefault"
