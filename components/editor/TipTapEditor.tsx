  ...
  const editor = useEditor({
    extensions: [
      ...
      TagMention.configure({
        HTMLAttributes: {
          class:
            "inline-flex items-center gap-1 rounded-md bg-primary/10 px-2 py-0.5 text-sm font-medium text-primary",
        },
      ...
      PeopleMention.configure({
        HTMLAttributes: {
          class:
            "inline-flex items-center gap-1 rounded-md bg-blue-500/10 px-2 py-0.5 text-sm font-medium text-blue-600 dark:text-blue-400",
        },
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert max-w-none focus:outline-none min-h-[300px] px-4 py-3",
      },
    },
...
export { TipTapEditor, getMarkdown, setMarkdown, useEditor };
